    ...
    <div className="about" data-aos="fade-left">
      <div className="about-left">
        <div className="about-left-wrapper">
          <div
            className="about-bg"
            style={{ backgroundColor: theme.state.darkMode ? "#ccc" : undefined }}
          ></div>
        ...
        <div className="about-right-wrapper">
          <div className="about-card-upper">
            ...
            <div className="linkedin-container">
              <a className="linkedin-button" href={about.linkedInUrl}>
            ...
            />
            <div className="about-desc">{about.description}</div>
          </div>
          <div className="about-card-lower">
            <div className="award-image">
              <img
                src={about.award.imagePath}
                alt={about.award.imageAlt}
                className="award-imagepic"
              />
            </div>
            <div className="award-body">
              <h4 className="award-title">{about.award.title}</h4>
              <div className="award-text">{about.award.description}</div>
            </div>
          </div>
        </div>
      </div>
